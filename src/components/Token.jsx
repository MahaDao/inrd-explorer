...
const Token = (props) => {
  ...
  const name = props.token.replace('gem', 'weth').replace('gov', 'maha').replace('skr', 'peth').replace('dai', 'inrd');
  ...
  const tapBalanceDesc = props.token === 'gem'
                          ? 'Amount of ETH available to cash for INRD'
                          : (props.token === 'skr'
                            ? 'Amount of PETH collateral pending liquidation via bust'
                            : (props.token === 'dai'
                              ? 'Amount of surplus INRD pending sale via boom'
                              : ''));
  return (
